...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "FoodService", Version = "v1" });
...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(typeof(CreateMenuItemCommandHandler).Assembly));
